...
pub type ThirdB075 {
  ThirdB075(id: Int, from_sta_code: String, sta_code: String, sta_name: String)
}
...
pub fn from_tuple_thirdb075(tup: #(Int, String, String, String)) {
  ThirdB075(tup.0, tup.1, tup.2, tup.3)
}
